      ...
      <aside className="w-[220px] bg-white border-r border-gray-200 flex flex-col shrink-0">
        ...
        <div className="p-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-lime-600 bg-clip-text text-transparent">
              Social Media Genius
            </span>
          ...
          {NAV_ITEMS.map((item) => (
            <button
              ...
              onClick={() => {
                ...
                if (item.id === "projects") {
                  // Just scroll to projects section or filter
                }
              }}
        ...
        <div className="p-6 space-y-8 max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white text-sm font-medium rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-sm hover:shadow-md cursor-pointer"
            >
