---
description: These instructions should be loaded when working on the social-media-genius repository, specifically for tasks related to social media automation, content generation, scheduling, and platform API integrations.
applyTo: **/*
---
